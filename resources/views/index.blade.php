...
@section('content')
  <main>
    ...
    <section class="home-section home-full-height bg-dark bg-gradient" id="home" data-background={{ asset("/images/section-10.jpg") }}>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-sm-offset-3">
              <h2 class="module-title font-alt">TENTANG SAYA</h2>
              <div class="module-subtitle font-serif">
                Hai! Perkenalkan nama saya Janaka Jati Lasmana, <br />
                Saya adalah seorang Software Developer dengan pengalaman berkerja lebih dari 3 tahun,
                dengan berbekal skill programming untuk membuat Website dan juga aplikasi mobile Androis & iOS
              </div>
            </div>
          </div>
          <div class="row multi-columns-row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="features-item">
                ...
                <h3 class="features-title font-alt">ANDROID & IOS</h3>
                <p>Careful attention to detail and clean, well structured code ensures a smooth user experience for all your visitors.</p>
              </div>
            </div>
            <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="row">
            <div class="col-sm-6 col-md-3 col-lg-3">
              <div class="alt-features-item">
                ...
                <h3 class="alt-features-title font-alt">Laravel</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
              </div>
              <div class="alt-features-item">
                <div class="alt-features-icon">
            ...
            <div class="col-sm-6 col-md-3 col-lg-3">
              <div class="alt-features-item">
                ...
                <h3 class="alt-features-title font-alt">React Native</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
              </div>
              <div class="alt-features-item">
                <div class="alt-features-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                ...
                <h3 class="alt-features-title font-alt">Node.js</h3>A wonderful serenity has taken possession of my entire soul like these sweet mornings.
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
              <div class="team-item">
                <div class="team-image"><img src={{ asset("/images/team-1.jpg") }} alt="Member Photo"/>
            ...
            <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
              <div class="team-item">
                <div class="team-image"><img src={{ asset("/images/team-2.jpg") }} alt="Member Photo"/>
                  <div class="team-detail">
            ...
            <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
              <div class="team-item">
                <div class="team-image"><img src={{ asset("/images/team-3.jpg") }} alt="Member Photo"/>
                  <div class="team-detail">
          ...
          <div class="row multi-columns-row post-columns">
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="post mb-20">
                <div class="post-thumbnail"><a href="#"><img src={{ asset("/images/post-1.jpg") }} alt="Blog-post Thumbnail"/></a></div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="post mb-20">
                <div class="post-thumbnail"><a href="#"><img src={{ asset("/images/post-2.jpg") }} alt="Blog-post Thumbnail"/></a></div>
                <div class="post-header font-alt">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4">
              <div class="post mb-20">
                <div class="post-thumbnail"><a href="#"><img src={{ asset("/images/post-3.jpg") }} alt="Blog-post Thumbnail"/></a></div>
                <div class="post-header font-alt">
