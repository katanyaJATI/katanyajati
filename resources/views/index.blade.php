        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              ...
              <li><a class="section-scroll" href="#services">Tentang Saya</a></li>
              <li><a class="section-scroll" href="#works">Projects</a></li>
            ...
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="module-subtitle font-serif">
                  Software Developer dengan pengalaman berkerja lebih dari 3 tahun. Berusaha semaksimal mungkin, be a productive person!
                </div>
              </div>
            </div>
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src={{asset("/images/promo.png")}} alt="Feature Image"></div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
